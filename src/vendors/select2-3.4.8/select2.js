    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "<ul class='select2-choices' style='padding-left:7px'>",
        ...
        addSelectedChoice: function (data) {
            ...
            if(enableChoice){
              choice.find(".select2-search-choice-close")
                  ...
                  if (!this.isInterfaceEnabled()) return;
                  if(!confirm($.i18n.prop("lang_select2deletecfrm"))){//"삭제 하시겠습니까?"
                	return;  
                  };
                  this.uncheckbox();
        ...
        //	var i="[Private]웹케시 개발팀";
        	/*var i=this.choice.find("div").text();
        	console.log(i);
        	var group = i.split(']');
        	alert(group[1]);*/
        },
...
//        formatMatches: function (matches) { return matches + "결과를 사용할 수 있습니다. 탐색하려면 위아래 화살표 키를 사용하세요."; },
        formatMatches: function (matches) { return matches + " results are available, use up and down arrow keys to navigate."; },
        formatNoMatches: function () { return $.i18n.prop("lang_select2nomatchfound"); }, //return "검색된 결과가 없습니다.";
        formatInputTooShort: function (input, min) { var n = min - input.length; return $.i18n.prop("lang_select2hiddenaccess", n); },// 글자 이상을 입력하세요.
        formatInputTooLong: function (input, max) { var n = input.length - max; return $.i18n.prop("lang_select2delchar", n); },//return n+" 글자를 삭제하세요."; 
        formatSelectionTooBig: function (limit) { return $.i18n.prop("lang_select2limititems", limit);}, // return limit+" 항목만 선택할 수 있습니다.";
        formatLoadMore: function (pageNumber) { return $.i18n.prop("lang_select2loadingmoreresult"); }, // return "더 많은 결과 로드 중...";
        formatSearching: function () { return $.i18n.prop("lang_select2searching");}, //return "검색 중..."; 

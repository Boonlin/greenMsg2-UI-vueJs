...
//show room 2015-may-20
function cttn_event_showroom_smartApp(ptlUrl){
//	_topWinPop("frmStnd", {"sizeW":"1024","sizeH":"913", "action":ptlUrl+"","target":"smartAppDown", "scroll":"no"});
//	windowObjectReference = window.open(ptlUrl,"","resizable,scrollbars");
	var windowObjectReference;
	var strWindowFeatures = "menubar=yes,location=yes,resizable=yes,scrollbars=yes,status=yes";
	windowObjectReference = window.open(ptlUrl, "CNN_WindowName", strWindowFeatures);
}

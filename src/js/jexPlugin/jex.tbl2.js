...
var PLUGIN_JEXTBL	= JexPlugin.extend({
	init : function(tbl) {
		...
		this.pageCntPrefix	= "<a href=\"javascript:\" class=\"generated\"><img src=\"../img/btn/btn_page_first.gif\" alt=\"처음으로\" /><span class=\"paging_num\"></span></a>";
		this.pageCntPostfix	= "<a href=\"javascript:\" class=\"generated\"><img src=\"../img/btn/btn_page_last.gif\" alt=\"끝으로\" /><span class=\"paging_num\"></span></a>";
...
//		else										return false;
    ...
    onPageChange : function() {
		...
		this.pageDiv.html("");
		this.pageDiv.parents(".paging_box").find(".generated").remove();
...
jex.plugin.add("JEX_TBL2", PLUGIN_JEXTBL, "data-jx-table");

...
var PLUGIN_JEXTBL	= JexPlugin.extend({
	init : function(tbl) {
		...
		this.pageCntPrefix	= "<li class=\"generated\"><a href=\"javascript:\"><img src=\"../../imgs/btn/btn_prev.png\" alt=\"이전 페이지\" /><span class=\"blind\">이전 페이지</span></a></li>";
		this.pageCntPostfix	= "<li class=\"generated\"><a href=\"javascript:\"><img src=\"../../imgs/btn/btn_next.png\" alt=\"다음 페이지\" /><span class=\"blind\">다음 페이지</span></a></li>";
		this.firstPageDiv		= "<li class=\"generated\"><a href=\"javascript:\"><img src=\"../../imgs/btn/btn_first.png\" alt=\"처음 페이지\" /><span class=\"blind\">처음 페이지</span></a></li>";
		this.lastPageDiv		= "<li class=\"generated\"><a href=\"javascript:\"><img src=\"../../imgs/btn/btn_last.png\" alt=\"마지막 페이지\" /><span class=\"blind\">마지막 페이지</span></a></li>";
    ...
    onPageChange : function() {
		...
		first.click(function() {
			if(_tblThis.getCurrentPage() == 1 && _tblThis.svrPageNo == 1) {
				//jex.warning(jex.null2Str(_extLang.firstPage,"첫번째 페이지입니다."));//첫번째 페이지입니다.
				jex.warning(jex.null2Str($.i18n.prop("lang_firstPage"),"첫번째 페이지입니다."));//첫번째 페이지입니다.
			}
			else {
				var hash = {};
				hash['currentPage']	=	"1";
...
//			});
			...
			prefix.click(function() {
				jex.warning(jex.null2Str($.i18n.prop("lang_noPrePage"), "이전페이지가 존재하지 않습니다.")); //이전페이지가 존재하지 않습니다. 
			});
		}
		...
		last.click(function() {
			...
			if(currentPage == _tblThis.currentPage && _tblThis.svrPageNo == lastSvrPageNo) {
				//jex.warning(jex.null2Str(_extLang.lastPage, "마지막 페이지입니다.")); // 마지막 페이지입니다.
				jex.warning(jex.null2Str($.i18n.prop("lang_lastPage"), "마지막 페이지입니다."));
				} 
			else {
				var hash = {};
...
//			postfix.insertAfter(this.pageDiv.parent());
			...
			postfix.click(function() {
				//jex.warning(jex.null2Str(_extLang.noNextPage, "다음페이지가 존재하지 않습니다."));//다음페이지가 존재하지 않습니다.
				jex.warning(jex.null2Str($.i18n.prop("lang_noNextPage"), "다음페이지가 존재하지 않습니다."));
			});
		}
